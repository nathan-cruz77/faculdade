...
iNSERT iNTO Clinica VALUES (4, 'clinica sagrado coracao de jesus', 'sagrada familia');
iNSERT iNTO Clinica VALUES (5, 'clinica urologica', 'sagrada familia');
iNSERT iNTO Clinica VALUES (6, 'clinica dermatologica flor da pele',  'funcionarios');
iNSERT iNTO Clinica VALUES (7, 'ortocentro', 'padre eustaquio');
iNSERT iNTO Clinica VALUES (8, 'clinica bem estar', 'mangabeiras');
iNSERT iNTO Clinica VALUES(9, 'clinica oftalmologica', 'santa efigenia');
